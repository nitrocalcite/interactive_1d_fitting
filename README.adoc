...
* `git clone https://github.com/nitrocalcite/ivfit`
* `cd ivfit`
* `make install`
* Have fun!

This method uses https://python-poetry.org/docs/[Poetry] to manage dependencies and publication. Locked dependencies are also available directly to `pip` from `requirements.lock`, to support installing without Poetry:
